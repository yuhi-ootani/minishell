...
#    Updated: 2025/04/03 15:48:12 by oyuhi            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = $(MAIN_DIR)/main.c $(MAIN_DIR)/main_init.c  \
	   ...
	   $(UTILS_DIR)/utils.c $(UTILS_DIR)/debug_utils.c $(UTILS_DIR)/quotes_removal_utils.c $(UTILS_DIR)/split_quoted_words_utils.c  \
