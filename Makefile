...
#    Updated: 2025/04/09 13:24:40 by knemcova         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = $(MAIN_DIR)/main.c $(MAIN_DIR)/main_init.c  \
	   ...
	   $(BUILTINS_DIR)/ft_cd.c $(BUILTINS_DIR)/ft_echo.c $(BUILTINS_DIR)/ft_env.c $(BUILTINS_DIR)/ft_exit.c $(BUILTINS_DIR)/ft_export.c $(BUILTINS_DIR)/ft_export_get_value.c $(BUILTINS_DIR)/ft_export_sort_print.c $(BUILTINS_DIR)/ft_unset.c $(BUILTINS_DIR)/ft_pwd.c \
	   $(UTILS_DIR)/utils.c $(UTILS_DIR)/debug_utils.c $(UTILS_DIR)/utils_env.c \
	   $(EXECUTOR_DIR)/executor.c $(EXECUTOR_DIR)/redirection.c $(EXECUTOR_DIR)/build_envp_array.c $(EXECUTOR_DIR)/child_process.c $(EXECUTOR_DIR)/execute_cmd.c $(EXECUTOR_DIR)/run_commands_in_child.c $(EXECUTOR_DIR)/handle_heredoc.c $(EXECUTOR_DIR)/set_heredoc_and_signals.c \
