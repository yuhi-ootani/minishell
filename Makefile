...
#    Updated: 2025/04/03 17:37:28 by oyuhi            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = $(MAIN_DIR)/main.c $(MAIN_DIR)/main_init.c  \
	   ...
	   $(BUILTINS_DIR)/ft_cd.c $(BUILTINS_DIR)/ft_echo.c $(BUILTINS_DIR)/ft_env.c $(BUILTINS_DIR)/ft_exit.c $(BUILTINS_DIR)/ft_export_main.c $(BUILTINS_DIR)/ft_export_sort_print.c $(BUILTINS_DIR)/ft_export_set_env.c $(BUILTINS_DIR)/ft_unset.c $(BUILTINS_DIR)/ft_pwd.c \
	   $(UTILS_DIR)/utils.c $(UTILS_DIR)/env_utils.c $(UTILS_DIR)/quotes_removal_utils.c $(UTILS_DIR)/split_quoted_words_utils.c  \
	   $(EXECUTOR_DIR)/executor.c $(EXECUTOR_DIR)/redirection.c $(EXECUTOR_DIR)/child_process_execute.c $(EXECUTOR_DIR)/child_process_setup.c  $(EXECUTOR_DIR)/run_commands_in_child.c $(EXECUTOR_DIR)/handle_heredoc.c \
